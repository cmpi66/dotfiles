...
vim.keymap.set("n", "<leader>zf", function()
  notes.new_note("~/.local/share/notes/zettlekasten/fleeting")
end, { desc = "Notes: New Fleeting note" })

vim.keymap.set("n", "<leader>zp", function()
  notes.new_note("~/.local/share/notes/zettlekasten/permanent")
end, { desc = "Notes: New Permanent note" })

vim.keymap.set("n", "<leader>zl", function()
  notes.new_note("~/.local/share/notes/zettlekasten/literature")
...
vim.keymap.set("n", "<leader>zo", function()
  require("snacks").picker("files", { cwd = notes.current_root() })
end, { desc = "Notes: Open note by file" })

-- Grep across entire ZK
vim.keymap.set("n", "<leader>zs", function()
  require("snacks").picker("grep", { cwd = notes.current_root() })
...
vim.keymap.set("n", "<leader>zt", notes.search_by_tag, { desc = "Notes: Search by tag" })
