...
"JetBrainsMono Nerd Font:style=Bold:size=14:antialias=true:autohint=true"

};

//static const char dmenufont[]       = "FuraCode Nerd Font Bold:size=12";

//background bar color
static const char col_gray1[]       = "#161320";
//inactive windwo border color
...
const char *spcmd1[] = {"st", "-n", "spterm", "-g", "110x25", NULL };
...
static const char *dmenucmd[] = { "dmenu_run","-l", "20", "-p", "Run : ", NULL };
