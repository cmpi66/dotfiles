...
{ MODKEY|ShiftMask,		            XK_BackSpace,	spawn,	   SHCMD("i3lock -C -i /home/chris/.local/bin/lock.jpg")  },
  // { MODKEY,		          	        XK_w,		spawn,            {.v = (const char*[]){ BROWSER, NULL } } },
  { MODKEY,		          	        XK_w,		spawn,            SHCMD("ld-system-preload-disable librewolf")  },
