...
complete -c picom -l write-pid-path -d 'Write process ID to a file'
...
complete -c picom -l corner-radius -d 'Round the corners of windows.  (defaults to 0)'
complete -c picom -l rounded-corners-exclude -d 'Exclude conditions for rounded corners'
complete -c picom -l round-borders -d 'When rounding corners, Round the borders of windows.  (defaults to 1)'
complete -c picom -l round-borders-exclude -d 'Exclude conditions for rounding borders'
...
complete -c picom -l paint-on-overlay -d 'may make the flickering less obvious'
complete -c picom -l use-damage
complete -c picom -l vsync-use-glfinish -d 'might fix some rendering issues with this backend'
complete -c picom -l blur-strength -d 'command line option.  If not specified, the value requested by'
